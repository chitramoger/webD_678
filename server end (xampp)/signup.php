...
input[type=intval], input[type=password] {
    width: 100%;
    padding: 15px;
    margin: 5px 0 22px 0;
    display: inline-block;
...
<form action="/sign_success.php" method="POST">
  <div class="container">
    <h1>Register</h1>
	...
	<input type="intval" placeholder="Enter valid 10digit number" name="MOBILE_NUMBER" required>
